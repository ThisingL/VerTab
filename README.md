...
Chrome 顶部的标签栏在 10 个标签以后就变成了一堆看不清的小图标。VerTab 把标签页放到侧边栏，提供一个可滚动、可搜索、可分组的垂直列表 — 和 [Arc 浏览器](https://sspai.com/post/81386)一样的体验，但无需更换浏览器。

![image-20260303223621045](assets/image.png)
